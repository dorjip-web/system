...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .hero h1{margin:0 0 12px;font-size:32px;line-height:1;color:#fff}
        ...
        .input{display:flex;align-items:center;background:#061222;border:1px solid rgba(255,255,255,0.04);padding:10px 12px;border-radius:8px}
        ...
        .btn-primary{background:linear-gradient(90deg,#3b82f6,#6ee7b7);color:#042028}
